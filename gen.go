...
//go:generate go run ./cmd/tomltestgen/main.go -r v2.1.0 -p unstable -o unstable/toml_testgen_test.go
//go:generate go run ./cmd/tomltestgen/main.go -r v2.1.0 -p unstable --ast -o unstable/parser_testgen_ast_test.go
